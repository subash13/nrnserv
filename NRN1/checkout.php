                                ...
                                <form action="#">
                                    ...
                                    <div class="order_table table-responsive">
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td> Transportation & Accomodation </td>
                                                    <td> $50.00</td>
                                                </tr>
                                    ...
                                    <div class="payment_method">
                                        <div class="panel-default">
                                            ...
                                            <label for="payment" data-toggle="collapse" data-target="#method" aria-controls="method">Pay by Bank Transfer / Remit Transfer</label>
                                        ...
                                        <div class="panel-default">
                                            ...
                                            <div id="collapsedefult" class="collapse one" data-parent="#accordion">
                                                <div class="card-body1">
                                                    <p>Pay via PayPal; it’s simple. Just an email address and password will get you through to checkout before you can reach for your wallet.</p>
                                                </div>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12">
                                            <div class="order-notes">
                                                ...
                                                <textarea  rows="4" id="order_note" placeholder="Notes about your order, e.g. special notes for delivery."></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </form>
