                ...
                <div class="col-lg-3 col-md-5 col-sm-7">
                    <div class="widgets_container contact_us">
                        ...
                        <div class="aff_content">
                            <p>To be the most trusted and respected professional services firm recognized by NRN’s for delivering
                                excellence and become a One Point Solution for all the needs in Nepal. We are on a mission to make the
                                Life of NRN that is you, easier by providing you professional service for all your diverse day to day
                                issues and other routine issues in Nepal.</p>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="widgets_container widget_menu">
                        ...
                        <div class="footer_menu">
                            <ul>
                                ...
                                <li><a href="blop.php">Recent Blog</a></li>
                                <li><a href="#">Desclaimer</a></li>
                                <li><a href="#">Sign In</a></li>
                                <li><a href="my-account.html">Register Now</a></li>
                ...
                <div class="col-lg-3 col-md-7 col-sm-12">
                    <div class="widgets_container">
                        ...
                        <div class="footer_contact">
                            ...
                            <p>Anamnagar, Kathmandu, Nepal. Support@services2nrn.com</p>
                        </div>
